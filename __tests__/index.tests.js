...
const expectedJson = readFile('file.json_result.txt');
const fileYml1 = getFixturePath('file1.yml');
const fileYml2 = getFixturePath('file2.yml');
const expectedYml = readFile('file.yml_result.txt');
...
// const expected = readFile('file.json_result.txt');
// const actual = genDiff(getFixturePath('file1.json'), getFixturePath('file2.json'));
// expect(actual).toBe(expected);
// });
// test('check file.yml', () => {
// const expected = readFile('file.yml_result.txt');
